...
class StableDiffusionXLImageTextJointControlPipeline_PooledOnly(
    ...
    def __init__(
        ...
        condition_image_processor: CLIPImageProcessor,
        ...
        self.register_modules(
            ...
            condition_image_processor=condition_image_processor,
        )
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            pixel_values = self.condition_image_processor(
                condition_image, return_tensors="pt"
            ).pixel_values.to(device)
            pooled_prompt_embeds = self.image_encoder(pixel_values)[0].to(device)
