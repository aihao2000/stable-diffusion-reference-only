...
class StableDiffusionXLJointControlPipeline(
    ...
    def __init__(
        ...
        self.register_modules(
            ...
            image_clip_processor=image_clip_processor,
            image_clip_processor_2=image_clip_processor_2,
            unet=unet,
            scheduler=scheduler,
        )
    ...
    def encode_prompt(
        ...
        image_clip_processors = (
            [self.image_clip_processor, self.image_clip_processor_2]
            if self.image_clip_processor is not None
            else [self.image_clip_processor_2]
        )
        image_encoders = (
            [self.image_encoder, self.image_encoder_2]
            if self.image_encoder is not None
            else [self.image_encoder_2]
        )
    ...
    def load_lora_weights(
        ...
        **kwargs,
        ...
        state_dict, network_alpha = self.lora_state_dict(
            pretrained_model_name_or_path_or_dict, **kwargs
        )
        self.load_lora_into_unet(
            state_dict, network_alpha=network_alpha, unet=self.unet
        )
