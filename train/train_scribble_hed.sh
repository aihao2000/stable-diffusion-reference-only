accelerate launch --mixed_precision=fp16 --multi_gpu train/train_sd_reference_only_controlnet_aux.py \
    ...
    --validation_prompt "validation_images/1/1_capture.jpg" "validation_images/2/1_capture.jpg" "validation_images/3/1_capture.jpg" "validation_images/4/1_capture.jpg" \
    --validation_blueprint "validation_images/1/2_scribble_hed.jpg" "validation_images/2/2_scribble_hed.jpg" "validation_images/3/2_scribble_hed.jpg" "validation_images/4/2_scribble_hed.jpg" \
    --use_8bit_adam \
