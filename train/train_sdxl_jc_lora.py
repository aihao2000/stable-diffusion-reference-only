...
def parse_args(input_args=None):
    ...
    parser.add_argument("--validation_image_prompt_path", type=str, default=None)
    parser.add_argument(
        "--max_train_samples",
        type=int,
        default=None,
...
def main(args):
    ...
    def collate_fn(examples):
        ...
        prompt = [example[prompt_column] for example in examples]
        image_prompt = [example[image_prompt_column] for example in examples]
        return {
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                prompt_embeds, pooled_prompt_embeds = encode_prompt(
                    ...
                    image_encoder_2=image_encoder_two,
                    image_clip_processor=image_clip_processor_one,
                    image_clip_processor_2=image_clip_processor_two,
                    text_prompt=batch["prompt"],
                    image_prompt=batch["image_prompt"],
                )
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if (
                        ...
                        and args.validation_image_prompt_path is not None
                        and epoch % args.validation_steps == 0
                    ):
                        logger.info(
                        ...
                        pipeline_args = {
                            ...
                            "image_prompt": Image.open(
                                args.validation_image_prompt_path
                            ),
                        }
